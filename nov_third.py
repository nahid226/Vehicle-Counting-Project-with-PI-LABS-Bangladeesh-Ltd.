...
root.title("Vehicle Speed Detection")
...
lbl1=Label(topframe,font=('arial',50,'bold'),bg="purple",text="Vehicle Speed Detection", fg= "white",bd=10,anchor='w').pack()
...
f7_count=Frame(root, width=100, height=50)
f7_count.pack()
button3=Button(f7_count, text="CHECK DIRECTION COUNTING", fg="red",bg="black", font=('arial',20,'bold'),command=count_dir)
button3.pack()

f6_quit=Frame(root,width=100,height=100)
f6_quit.pack()

button4=Button(f6_quit, text="Q U I T", fg="white",bg="black", font=('arial',20,'bold'), command=quit)
button4.pack()
